...
function event_spawn(e)
        ...
        eq.spawn_condition(217, eq.get_zone_instance_id(), 1, 0)
        eq.spawn_condition(217, eq.get_zone_instance_id(), 2, 0)
...
function event_timer(e)
        if e.timer == "Wave" then
                ...
                if spawnwave then
                        ...
                        if fennin == 1 then
                                eq.spawn_condition(217, eq.get_zone_instance_id(), 1, 1)
                        ...
                        elseif fennin == 3 then
                                eq.spawn_condition(217, eq.get_zone_instance_id(), 2, 1)
